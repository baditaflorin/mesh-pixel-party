# Security audit — mesh-pixel-party

Generated: **2026-08-22T13:14:32.488Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "47d623e6205e6952ed8e2470819d0ea1d68bf2a2ae2967c79610a231058da867",
  "pubkeyB": "47d623e6205e6952ed8e2470819d0ea1d68bf2a2ae2967c79610a231058da867"
}
```
...
```json
{
  "pubkeyA": "c0bf80c67910eb17",
  "pubkeyB": "dc4e54240e6e998a"
}
```
...
```json
{
  "plantedExpiresAt": 1787404412481,
  "now": 1787404472484
}
```
...
```json
{
  "realPubkey": "1550824296f1e93e",
  "forgerPubkey": "f3dad4b48d602ddc"
}
```
...
```json
{
  "forgedPubkey": "ca16ed4ee884a31a",
  "realPubkey": "25f570d8a6ede9d0"
}
```
