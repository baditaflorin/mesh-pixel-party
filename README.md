...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-pixel-party-0891b2)](https://baditaflorin.github.io/mesh-pixel-party/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-pixel-party/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A compact shared pixel-art canvas for small rooms.

**Live → https://baditaflorin.github.io/mesh-pixel-party/**

**Source → https://github.com/baditaflorin/mesh-pixel-party**
...
git clone https://github.com/baditaflorin/mesh-pixel-party
cd mesh-pixel-party
npm install
npm run dev
```
...
- `mesh-pixel-party:signalingUrl`
- `mesh-pixel-party:turnTokenUrl`
- `mesh-pixel-party:iceServers`
- `mesh-pixel-party:room`
